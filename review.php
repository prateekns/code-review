...
- For each issue, use an exact changed line from the provided diff
- In issue.message, include scope or function name when available
- Provide detailed issue.message with concrete impact and condition
PROMPT;
