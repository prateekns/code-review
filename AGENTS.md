...
## Activation Rule (IMPORTANT)

These review rules are ONLY activated when the prompt contains the word "review".

Examples:
- `review app/file.php` → Apply rules
- `fix the bugs` → Normal response
- `explain this code` → Normal response
...
| Score | Severity | Color Code | Action Required |
|-------|----------|------------|------------------|
| 0-2   | Critical | 🔴 Red     | Immediate        |
| 3-5   | High     | 🟠 Orange  | Urgent           |
| 6-7   | Medium   | 🟡 Yellow  | Scheduled         |
| 8-9   | Low      | 🟢 Green   | Optional          |
| 10    | Perfect  | ✅ None    | None              |
...
- `review <file>` → Run ALL categories
- `review:<category>` → Run ONLY that category
- `review:cat1,cat2` → Run ONLY specified categories
- Do NOT include unrequested categories
...
### Top Fix Suggestions (Max 5)

Provide detailed explanation issues.

---

### What is Correct

- Mention 2 good practices followed

---

## Final Instructions

- Always include BOTH JSON and human-readable sections
- Keep output concise and scannable
- Prioritize security issues
- Follow requested categories only
